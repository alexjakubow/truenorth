...
#
# This script creates a table that captures the current open science status of all preprints in the database.  Not to be confused with *lifecycle* open science status, the field generated by this script captures whether or a preprint currently meets a minimum set of criteria to be considered an Open Science Preprint (OSP).  See `R/criteria.R` for the full set of criteria.
#
# Input tables:
