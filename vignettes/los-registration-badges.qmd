...
<!-- For instance, when looking within the "First" column, we see that Data is most frequently linked first (40%), followed by Supplements.  Moving across the table, Code tends to follow (54% of all second connections), and Papers tend to appear more commonly in the later connections (4th and 5th).  Supplements are most likely to be the last linked resource provided---at least among our sample of OSRs with at least two linked resources and in instances where users went through the effort of already linking four resources. -->
