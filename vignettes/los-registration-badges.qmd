...
TABLE_CRITERIA <- c(
    "los_plan", "los_outcomes", "los_outputs", "los_complete")
TABLE_NAMES <- c(
    "OSR", "OSR + Outcome(s)", "OSR + Output(s)",
    "LOS-Reg"
)
```
...
- `LOS-Reg`: Lifecycle Open Science Registrations - number of Open Science Registrations with at least one linked outcome and at least one linked output badge
