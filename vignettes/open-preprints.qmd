...
If a preprint has no visibility actions in the log table but appears as public in the `osf_preprint` table, we assume the preprint was made public at the time of creation (`created`)
...
The following graph plots the distribution of preprints along the five different sub-criteria of interest denoted at the beginning.  Preprints can be duplicated across criteria.  The total number of preprints is shown in black.
